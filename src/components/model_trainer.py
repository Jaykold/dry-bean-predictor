...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array:np.ndarray, val_array:np.ndarray, features_val)->str:
        ...
        try:
            ...
            initialize_mflow()
            models_result:dict = random_search_hyperparameter_tuning_classification(X_train, y_train, params)
            best_model_uri = log_best_model(models_result, features_val)
