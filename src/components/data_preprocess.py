...
class DataProcess:
    ...
    def initiate_data_preprocessing(self,
            ...
            try:
                ...
                # Apply SMOTE to train and target features
                ...
                save_object(obj=smote,
                            file_path=self.data_preprocessor_config.smote_file_path )
                save_object(obj=scaler,
                            file_path=self.data_preprocessor_config.scaler_file_path)
                save_object(obj=label_encoder,
                            file_path=self.data_preprocessor_config.labelencoder_path)
